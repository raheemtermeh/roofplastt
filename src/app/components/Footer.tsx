      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-4">
              تولیدکننده تخصصی سیستم‌های زهکش برای چمن‌های مصنوعی با بیش از ۱۵ سال تجربه
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><span className="hover:text-emerald-400 transition-colors cursor-default">تولید زهکش</span></li>
              <li><button onClick={() => handleNav('contact')} className="hover:text-emerald-400 transition-colors">مشاوره رایگان</button></li>
              <li><span className="hover:text-emerald-400 transition-colors cursor-default">نصب و راه‌اندازی</span></li>
              <li><span className="hover:text-emerald-400 transition-colors cursor-default">خدمات پس از فروش</span></li>
              <li><span className="hover:text-emerald-400 transition-colors cursor-default">گارانتی محصول</span></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:info@zahkesh.ir" className="hover:text-emerald-400 transition-colors">info@zahkesh.ir</a>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="border-t border-gray-800 pt-6 mt-8 flex flex-col md:flex-row items-center justify-between text-sm gap-4">
          ...
          <div className="flex gap-4">
            ...
            <button onClick={() => handleNav('contact')} className="text-emerald-400 hover:text-emerald-300 transition-colors">
              درخواست مشاوره
            </button>
          </div>
        </div>
